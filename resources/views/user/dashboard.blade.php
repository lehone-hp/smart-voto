            ...
            <div class="widget widget-account-invoice-three">
                ...
                <div class="widget-heading">
                    <div class="wallet-usr-info">
                        <div class="usr-name">
                            <span><img src="{{ asset('assets/img/profile-32.svg') }}" alt="admin-profile" class="img-fluid"> Alan Green</span>
                        </div>
                        <div class="add">
                                    <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                               viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                               stroke-linecap="round" stroke-linejoin="round"
                                               class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line
                ...
                <div class="widget-amount">
                    ...
                    <div class="w-a-info funds-received">
                                <span>Received <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                points="18 15 12 9 6 15"></polyline></svg></span>
                        <p>$97.99</p>
                    </div>
                ...
                <div class="widget-content">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/img/profile-13.svg') }}"
                                                                               alt="avatar"><span>Luke Ivory</span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/img/profile-7.svg') }}"
                                                                               alt="avatar"><span>Andy King</span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/img/profile-10.jpeg') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/img/profile-5.jpeg') }}"
                                                                               alt="avatar"><span>Ryan Collins</span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/img/profile-4.jpeg') }}"
                                                                               alt="avatar"><span>Irene Collins</span>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="td-content customer-name"><img src="{{ asset('assets/img/profile-11.jpeg') }}"
                                                                               alt="avatar"><span>Sonia Shaw</span>
                                    </div>
                                </td>
                                <td>
                ...
                <div class="widget-content">
                    <div class="table-responsive">
                        <table class="table table-scroll">
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img
                                                src="{{ asset('assets/img/product-headphones.jpg') }}" alt="product">
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('assets/img/product-shoes.jpg') }}"
                                                                              alt="product">
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img src="{{ asset('assets/img/product-watch.jpg') }}"
                                                                              alt="product">
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img
                                                src="{{ asset('assets/img/product-laptop.jpg') }}" alt="product">
                            ...
                            <tr>
                                <td>
                                    <div class="td-content product-name"><img
                                                src="{{ asset('assets/img/product-camera.jpg') }}" alt="product">
